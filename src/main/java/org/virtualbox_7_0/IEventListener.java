...
Interface ID: <code>{67099191-32E7-4F6C-85EE-422304C71B90}</code>
*/
...
passive listeners. After calling{@link #handleEvent(org.virtualbox_7_0.IEvent)}on all active listeners
and having received acknowledgement from all passive listeners via{@link org.virtualbox_7_0.IEventSource#eventProcessed(org.virtualbox_7_0.IEventListener,org.virtualbox_7_0.IEvent)}, the event is marked as
processed and{@link org.virtualbox_7_0.IEvent#waitProcessed(Integer)}will return
immediately.
@param event Event available.

*/
    public void handleEvent(org.virtualbox_7_0.IEvent event)
    {
        try
        {

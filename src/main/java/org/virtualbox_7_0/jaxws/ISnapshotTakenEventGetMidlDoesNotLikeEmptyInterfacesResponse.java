...
@XmlRootElement(name = "ISnapshotTakenEvent_getMidlDoesNotLikeEmptyInterfacesResponse")
public class ISnapshotTakenEventGetMidlDoesNotLikeEmptyInterfacesResponse {

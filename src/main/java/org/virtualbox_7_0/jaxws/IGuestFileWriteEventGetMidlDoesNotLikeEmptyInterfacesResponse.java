...
@XmlRootElement(name = "IGuestFileWriteEvent_getMidlDoesNotLikeEmptyInterfacesResponse")
public class IGuestFileWriteEventGetMidlDoesNotLikeEmptyInterfacesResponse {

...
@XmlRootElement(name = "IMouseCapabilityChangedEvent_getSupportsTouchScreenResponse")
public class IMouseCapabilityChangedEventGetSupportsTouchScreenResponse {

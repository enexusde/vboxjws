...
@XmlRootElement(name = "ICanShowWindowEvent_getMidlDoesNotLikeEmptyInterfacesResponse")
public class ICanShowWindowEventGetMidlDoesNotLikeEmptyInterfacesResponse {

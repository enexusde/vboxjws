 ...
 *         &lt;element name="type" type="{http://www.virtualbox.org/}USBControllerType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ISystemProperties_getMaxInstancesOfUSBControllerType")
public class ISystemPropertiesGetMaxInstancesOfUSBControllerType {
    ...
    @XmlElement(required = true)
    protected USBControllerType type;

...
@XmlRootElement(name = "ISystemProperties_getStorageControllerHotplugCapableResponse")
public class ISystemPropertiesGetStorageControllerHotplugCapableResponse {

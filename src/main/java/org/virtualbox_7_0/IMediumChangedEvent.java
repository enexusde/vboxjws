...
/**
Notification when a{@link org.virtualbox_7_0.IMachine#getMediumAttachments()}changes.

Interface ID: <code>{0FE2DA40-5637-472A-9736-72019EABD7DE}</code>
*/
...
*/
    public org.virtualbox_7_0.IMediumAttachment getMediumAttachment()
    {
        this.getObjMgr().preventObjRelease();
        try
        {
            org.virtualbox_7_0.jaxws.IMediumAttachment retVal = port.iMediumChangedEventGetMediumAttachment(obj);

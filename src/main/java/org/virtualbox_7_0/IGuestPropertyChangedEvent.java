...
Interface ID: <code>{2D0F4C6F-A77E-45C5-96D2-7CA7DAAE63A9}</code>
*/
public class IGuestPropertyChangedEvent extends IMachineEvent
{

    public IGuestPropertyChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
@return Boolean
*/
    public Boolean getFWasDeleted()
    {
        try
        {
            Boolean retVal = port.iGuestPropertyChangedEventGetFWasDeleted(obj);
            return retVal;
        }
        catch (InvalidObjectFaultMsg e)
        {
    ...
    {
        return obj == null ?  null : new IGuestPropertyChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

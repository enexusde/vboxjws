...
Interface ID: <code>{6DDEF35E-4737-457B-99FC-BC52C851A44F}</code>
*/
public class IKeyboardLedsChangedEvent extends IEvent
{

    public IKeyboardLedsChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new IKeyboardLedsChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

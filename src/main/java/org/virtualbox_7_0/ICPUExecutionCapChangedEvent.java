...
Interface ID: <code>{DFA7E4F5-B4A4-44CE-85A8-127AC5EB59DC}</code>
*/
public class ICPUExecutionCapChangedEvent extends IEvent
{

    public ICPUExecutionCapChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new ICPUExecutionCapChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

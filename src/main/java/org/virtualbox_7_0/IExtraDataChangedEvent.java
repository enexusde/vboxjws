...
Interface ID: <code>{024F00CE-6E0B-492A-A8D0-968472A94DC7}</code>
*/
public class IExtraDataChangedEvent extends IEvent
{

    public IExtraDataChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new IExtraDataChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

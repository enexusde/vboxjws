...
Interface ID: <code>{C354A762-3FF2-4F2E-8F09-07382EE25088}</code>
*/
public class IMachineRegisteredEvent extends IMachineEvent
{

    public IMachineRegisteredEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new IMachineRegisteredEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

...
Interface ID: <code>{C365FB7B-4430-499F-92C8-8BED814A567A}</code>
*/
public class IGuestProcessStateChangedEvent extends IGuestProcessEvent
{

    public IGuestProcessStateChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    public org.virtualbox_7_0.ProcessStatus getStatus()
    {
        try
        {
            org.virtualbox_7_0.jaxws.ProcessStatus retVal = port.iGuestProcessStateChangedEventGetStatus(obj);
...
*/
    public org.virtualbox_7_0.IVirtualBoxErrorInfo getError()
    {
        ...
        try
        {
            String retVal = port.iGuestProcessStateChangedEventGetError(obj);
    ...
    {
        return obj == null ?  null : new IGuestProcessStateChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

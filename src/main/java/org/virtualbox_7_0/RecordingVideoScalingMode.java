...
/*
 * RecordingVideoScalingMode.java
 *
...
Interface ID: <code>{0DD1127D-4F62-4B82-BEEE-91086A9F1D24}</code>
*/
...
*/
    ...
    RecordingVideoScalingMode(int v)
    {
        value = v;
    }
    ...
    {
        return valueOf(RecordingVideoScalingMode.class, v);
    }
}

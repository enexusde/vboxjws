...
Interface ID: <code>{CAC21692-7997-4595-A731-3A509DB604E5}</code>
*/
public class IClipboardModeChangedEvent extends IEvent
{

    public IClipboardModeChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    public org.virtualbox_7_0.ClipboardMode getClipboardMode()
    {
        try
        {
            org.virtualbox_7_0.jaxws.ClipboardMode retVal = port.iClipboardModeChangedEventGetClipboardMode(obj);
    ...
    {
        return obj == null ?  null : new IClipboardModeChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

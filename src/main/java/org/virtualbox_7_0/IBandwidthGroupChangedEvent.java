...
Interface ID: <code>{334DF94A-7556-4CBC-8C04-043096B02D82}</code>
*/
public class IBandwidthGroupChangedEvent extends IEvent
{

    public IBandwidthGroupChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new IBandwidthGroupChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

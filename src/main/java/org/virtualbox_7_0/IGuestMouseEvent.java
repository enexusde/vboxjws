...
Interface ID: <code>{179F8647-319C-4E7E-8150-C5837BD265F6}</code>
*/
public class IGuestMouseEvent extends IReusableEvent
{

    public IGuestMouseEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
@return org.virtualbox_7_0.GuestMouseEventMode
*/
    public org.virtualbox_7_0.GuestMouseEventMode getMode()
    {
        try
        {
            org.virtualbox_7_0.jaxws.GuestMouseEventMode retVal = port.iGuestMouseEventGetMode(obj);
            return org.virtualbox_7_0.GuestMouseEventMode.fromValue(retVal.value());
        }
...
*/
    ...
    {
        return obj == null ?  null : new IGuestMouseEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

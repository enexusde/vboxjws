...
Interface ID: <code>{69BFB134-80F6-4266-8E20-16371F68FA25}</code>
*/
public class IReusableEvent extends IEvent
{

    public IReusableEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new IReusableEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }

...
Interface ID: <code>{4DA2DEC7-71B2-4817-9A64-4ED12C17388E}</code>
*/
public class ICPUChangedEvent extends IEvent
{

    public ICPUChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new ICPUChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

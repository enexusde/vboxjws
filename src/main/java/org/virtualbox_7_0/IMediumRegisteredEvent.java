...
Interface ID: <code>{53FAC49A-B7F1-4A5A-A4EF-A11DD9C2A458}</code>
*/
public class IMediumRegisteredEvent extends IEvent
{

    public IMediumRegisteredEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    public org.virtualbox_7_0.DeviceType getMediumType()
    {
        try
        {
            org.virtualbox_7_0.jaxws.DeviceType retVal = port.iMediumRegisteredEventGetMediumType(obj);
...
*/
    ...
    {
        return obj == null ?  null : new IMediumRegisteredEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

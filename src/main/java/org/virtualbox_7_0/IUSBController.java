...
@return org.virtualbox_7_0.USBControllerType
*/
    public org.virtualbox_7_0.USBControllerType getType()
    {
        try
        {
            org.virtualbox_7_0.jaxws.USBControllerType retVal = port.iusbControllerGetType(obj);
            return org.virtualbox_7_0.USBControllerType.fromValue(retVal.value());
        }
        catch (InvalidObjectFaultMsg e)
        {
            throw new VBoxException(e.getMessage(), e, this.getObjMgr(), this.port);
...
/**
The USB Controller type.
@param value org.virtualbox_7_0.USBControllerType

*/
    public void setType(org.virtualbox_7_0.USBControllerType value)
    {
        try
        {
        port.iusbControllerSetType(obj, org.virtualbox_7_0.jaxws.USBControllerType.fromValue(value.name()));
        }
        catch (InvalidObjectFaultMsg e)
        {
            throw new VBoxException(e.getMessage(), e, this.getObjMgr(), this.port);

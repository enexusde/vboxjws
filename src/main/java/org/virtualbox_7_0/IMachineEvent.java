...
Interface ID: <code>{92ED7B1A-0D96-40ED-AE46-A564D484325E}</code>
*/
public class IMachineEvent extends IEvent
{

    public IMachineEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new IMachineEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

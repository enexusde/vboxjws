...
Interface ID: <code>{21637B0E-34B8-42D3-ACFB-7E96DAF77C22}</code>
*/
public class ISnapshotEvent extends IMachineEvent
{

    public ISnapshotEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new ISnapshotEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

...
Interface ID: <code>{24EEF068-C380-4510-BC7C-19314A7352F1}</code>
*/
public class INATRedirectEvent extends IMachineEvent
{

    public INATRedirectEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
@return org.virtualbox_7_0.NATProtocol
*/
    public org.virtualbox_7_0.NATProtocol getProto()
    {
        try
        {
            org.virtualbox_7_0.jaxws.NATProtocol retVal = port.inatRedirectEventGetProto(obj);
...
*/
    ...
    {
        return obj == null ?  null : new INATRedirectEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

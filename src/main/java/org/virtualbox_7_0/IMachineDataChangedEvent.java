...
Interface ID: <code>{ABE94809-2E88-4436-83D7-50F3E64D0503}</code>
*/
public class IMachineDataChangedEvent extends IMachineEvent
{

    public IMachineDataChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
        super(wrapped, objMgr, port);
    }

/**
true if the settings change is temporary. All permanent
...
*/
    ...
    {
        return obj == null ?  null : new IMachineDataChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

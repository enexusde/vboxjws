...
public class INATNetworkStartStopEvent extends INATNetworkChangedEvent
{
    ...
    public INATNetworkStartStopEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    public Boolean getStartEvent()
    {
        try
        {
            Boolean retVal = port.inatNetworkStartStopEventGetStartEvent(obj);
            return retVal;
        }
    ...
    {
        return obj == null ?  null : new INATNetworkStartStopEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

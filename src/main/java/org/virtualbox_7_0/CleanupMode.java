...
/**
Cleanup mode, used with{@link org.virtualbox_7_0.IMachine#unregister(org.virtualbox_7_0.CleanupMode)}.
Interface ID: <code>{67897C50-7CCA-47A9-83F6-CE8FD8EB5441}</code>
*/
...
/**
Delete all snapshots, detach all media and return hard disks and removable locating in the folder of the machine to be deleted and referenced only to this machine, for closing.
*/

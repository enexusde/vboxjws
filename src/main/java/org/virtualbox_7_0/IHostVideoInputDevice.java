...
Interface ID: <code>{E8C25D4D-AC97-4C16-B3E2-81BD8A57CC27}</code>
*/
public class IHostVideoInputDevice extends IUnknown
{

    public IHostVideoInputDevice(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
/**
An alias which can be used for{@link org.virtualbox_7_0.IEmulatedUSB#webcamAttach(String,String)}
@return String
*/
    ...
    {
        return obj == null ?  null : new IHostVideoInputDevice(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

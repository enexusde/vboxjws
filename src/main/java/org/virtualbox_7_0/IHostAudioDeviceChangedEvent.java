...
/*
 * IHostAudioDeviceChangedEvent.java
 *
...
Interface ID: <code>{8DCC633F-7B03-4F0A-9F40-7A784DD0835A}</code>
*/
public class IHostAudioDeviceChangedEvent extends IEvent
{

    public IHostAudioDeviceChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
@return org.virtualbox_7_0.IHostAudioDevice
*/
    public org.virtualbox_7_0.IHostAudioDevice getDevice()
    {
        this.getObjMgr().preventObjRelease();
        try
        {
            String retVal = port.iHostAudioDeviceChangedEventGetDevice(obj);
...
*/
    public Boolean getNew()
    {
        try
        {
            Boolean retVal = port.iHostAudioDeviceChangedEventGetNew(obj);
            return retVal;
        }
        catch (InvalidObjectFaultMsg e)
        {
...
*/
    public org.virtualbox_7_0.AudioDeviceState getState()
    {
        try
        {
            org.virtualbox_7_0.jaxws.AudioDeviceState retVal = port.iHostAudioDeviceChangedEventGetState(obj);
...
*/
    public org.virtualbox_7_0.IVirtualBoxErrorInfo getError()
    {
        ...
        try
        {
            String retVal = port.iHostAudioDeviceChangedEventGetError(obj);
    ...
    {
        return obj == null ?  null : new IHostAudioDeviceChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

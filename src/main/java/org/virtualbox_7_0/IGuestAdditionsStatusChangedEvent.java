...
Interface ID: <code>{A443DA5B-AA82-4720-BC84-BD097B2B13B8}</code>
*/
...
*/
    public org.virtualbox_7_0.AdditionsFacilityType getFacility()
    {
        try
        {
            org.virtualbox_7_0.jaxws.AdditionsFacilityType retVal = port.iGuestAdditionsStatusChangedEventGetFacility(obj);
...
*/
    public org.virtualbox_7_0.AdditionsFacilityStatus getStatus()
    {
        try
        {
            org.virtualbox_7_0.jaxws.AdditionsFacilityStatus retVal = port.iGuestAdditionsStatusChangedEventGetStatus(obj);
...
*/
    public org.virtualbox_7_0.AdditionsRunLevelType getRunLevel()
    {
        try
        {
            org.virtualbox_7_0.jaxws.AdditionsRunLevelType retVal = port.iGuestAdditionsStatusChangedEventGetRunLevel(obj);

...
virtual{@link org.virtualbox_7_0.IMachine#getSerialPort(Long)}changes.
Interested callees should use ISerialPort methods and attributes
to find out what has changed.

Interface ID: <code>{3BA329DC-659C-488B-835C-4ECA7AE71C6C}</code>
*/
public class ISerialPortChangedEvent extends IEvent
{

    public ISerialPortChangedEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
@return org.virtualbox_7_0.ISerialPort
*/
    public org.virtualbox_7_0.ISerialPort getSerialPort()
    {
    ...
    {
        return obj == null ?  null : new ISerialPortChangedEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

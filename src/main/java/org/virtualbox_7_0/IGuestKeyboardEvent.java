...
Interface ID: <code>{88394258-7006-40D4-B339-472EE3801844}</code>
*/
public class IGuestKeyboardEvent extends IEvent
{

    public IGuestKeyboardEvent(String wrapped, ObjectRefManager objMgr, VboxPortType port)
    {
...
*/
    ...
    {
        return obj == null ?  null : new IGuestKeyboardEvent(obj.getWrapped(), obj.getObjMgr(), obj.getRemoteWSPort());
    }
}

...
@XmlType(name = "", propOrder = { "_this", "listener", "interesting", "active" })
...
public class IEventSourceRegisterListener {
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link VBoxEventType
	 * }
	 * 
	 * 
	 */

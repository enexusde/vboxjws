...
/**
 * <p>
 * Java class for NetworkAttachmentType.
 * 
 * <p>
...
public enum NetworkAttachmentType {
	...
	@XmlEnumValue("Null")
	NULL("Null"), NAT("NAT"), @XmlEnumValue("Bridged")
	BRIDGED("Bridged"), @XmlEnumValue("Internal")
	INTERNAL("Internal"), @XmlEnumValue("HostOnly")
	HOST_ONLY("HostOnly"), @XmlEnumValue("Generic")
	GENERIC("Generic");

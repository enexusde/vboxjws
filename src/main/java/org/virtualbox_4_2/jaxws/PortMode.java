...
public enum PortMode {
	...
	DISCONNECTED("Disconnected"), @XmlEnumValue("HostPipe")
	HOST_PIPE("HostPipe"), @XmlEnumValue("HostDevice")
	HOST_DEVICE("HostDevice"), @XmlEnumValue("RawFile")
	RAW_FILE("RawFile");

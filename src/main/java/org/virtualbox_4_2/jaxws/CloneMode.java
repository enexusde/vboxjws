...
public enum CloneMode {
	...
	MACHINE_STATE("MachineState"), @XmlEnumValue("MachineAndChildStates")
	MACHINE_AND_CHILD_STATES("MachineAndChildStates"), @XmlEnumValue("AllStates")

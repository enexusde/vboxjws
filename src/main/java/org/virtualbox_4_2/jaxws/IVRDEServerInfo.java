...
@XmlType(name = "IVRDEServerInfo", propOrder = { "active", "port", "numberOfClients", "beginTime", "endTime",
		"bytesSent", "bytesSentTotal", "bytesReceived", "bytesReceivedTotal", "user", "domain", "clientName",
		"clientIP", "clientVersion", "encryptionStyle" })

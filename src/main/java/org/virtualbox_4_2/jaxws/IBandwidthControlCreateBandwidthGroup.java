...
@XmlType(name = "", propOrder = { "_this", "name", "type", "maxBytesPerSec" })
...
public class IBandwidthControlCreateBandwidthGroup {
	 ...
	 * 
	 * @return possible object is {@link BandwidthGroupType }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link BandwidthGroupType }
	 * 
	 */

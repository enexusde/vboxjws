...
public enum MediumState {
	...
	NOT_CREATED("NotCreated"), @XmlEnumValue("Created")
	CREATED("Created"), @XmlEnumValue("LockedRead")
	LOCKED_READ("LockedRead"), @XmlEnumValue("LockedWrite")
	LOCKED_WRITE("LockedWrite"), @XmlEnumValue("Inaccessible")
	INACCESSIBLE("Inaccessible"), @XmlEnumValue("Creating")
	CREATING("Creating"), @XmlEnumValue("Deleting")
	DELETING("Deleting");

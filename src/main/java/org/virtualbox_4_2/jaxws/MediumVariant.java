...
public enum MediumVariant {
	...
	STANDARD("Standard"), @XmlEnumValue("VmdkSplit2G")
	VMDK_SPLIT_2_G("VmdkSplit2G"), @XmlEnumValue("VmdkRawDisk")
	VMDK_RAW_DISK("VmdkRawDisk"), @XmlEnumValue("VmdkStreamOptimized")
	VMDK_STREAM_OPTIMIZED("VmdkStreamOptimized"), @XmlEnumValue("VmdkESX")
	VMDK_ESX("VmdkESX"), @XmlEnumValue("Fixed")
	FIXED("Fixed"), @XmlEnumValue("Diff")
	DIFF("Diff"), @XmlEnumValue("NoCreateDir")

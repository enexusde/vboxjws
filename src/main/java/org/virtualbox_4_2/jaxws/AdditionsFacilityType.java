...
/**
 * <p>
 * Java class for AdditionsFacilityType.
 * 
 * <p>
...
public enum AdditionsFacilityType {
	...
	@XmlEnumValue("None")
	NONE("None"), @XmlEnumValue("VBoxGuestDriver")
	V_BOX_GUEST_DRIVER("VBoxGuestDriver"), @XmlEnumValue("AutoLogon")
	AUTO_LOGON("AutoLogon"), @XmlEnumValue("VBoxService")
	V_BOX_SERVICE("VBoxService"), @XmlEnumValue("VBoxTrayClient")
	V_BOX_TRAY_CLIENT("VBoxTrayClient"), @XmlEnumValue("Seamless")
	SEAMLESS("Seamless"), @XmlEnumValue("Graphics")
	GRAPHICS("Graphics"), @XmlEnumValue("All")
	ALL("All");

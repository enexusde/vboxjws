...
@XmlType(name = "", propOrder = { "_this", "name", "controllerPort", "device" })
@XmlRootElement(name = "IMachine_setNoBandwidthGroupForDevice")
public class IMachineSetNoBandwidthGroupForDevice {

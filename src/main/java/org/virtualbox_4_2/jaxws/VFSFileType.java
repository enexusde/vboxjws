...
public enum VFSFileType {
	...
	UNKNOWN("Unknown"), @XmlEnumValue("Fifo")
	FIFO("Fifo"), @XmlEnumValue("DevChar")
	DEV_CHAR("DevChar"), @XmlEnumValue("Directory")
	DIRECTORY("Directory"), @XmlEnumValue("DevBlock")
	DEV_BLOCK("DevBlock"), @XmlEnumValue("File")
	FILE("File"), @XmlEnumValue("SymLink")
	SYM_LINK("SymLink"), @XmlEnumValue("Socket")

...
/**
 * <p>
 * Java class for AudioDriverType.
 * 
 * <p>
...
public enum AudioDriverType {
	...
	@XmlEnumValue("Null")
	NULL("Null"), @XmlEnumValue("WinMM")
	WIN_MM("WinMM"), OSS("OSS"), ALSA("ALSA"), @XmlEnumValue("DirectSound")
	DIRECT_SOUND("DirectSound"), @XmlEnumValue("CoreAudio")
	CORE_AUDIO("CoreAudio"), MMPM("MMPM"), @XmlEnumValue("Pulse")
	PULSE("Pulse"), @XmlEnumValue("SolAudio")
	SOL_AUDIO("SolAudio");

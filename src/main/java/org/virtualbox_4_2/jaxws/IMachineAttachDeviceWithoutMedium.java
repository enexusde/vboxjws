...
@XmlType(name = "", propOrder = { "_this", "name", "controllerPort", "device", "type" })
@XmlRootElement(name = "IMachine_attachDeviceWithoutMedium")
public class IMachineAttachDeviceWithoutMedium {

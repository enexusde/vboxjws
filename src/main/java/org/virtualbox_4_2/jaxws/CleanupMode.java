...
public enum CleanupMode {
	...
	UNREGISTER_ONLY("UnregisterOnly"), @XmlEnumValue("DetachAllReturnNone")
	DETACH_ALL_RETURN_NONE("DetachAllReturnNone"), @XmlEnumValue("DetachAllReturnHardDisksOnly")
	DETACH_ALL_RETURN_HARD_DISKS_ONLY("DetachAllReturnHardDisksOnly"), @XmlEnumValue("Full")
	FULL("Full");

...
/**
 * <p>
 * Java class for MouseButtonState.
 * 
 * <p>
...
public enum MouseButtonState {
	...
	LEFT_BUTTON("LeftButton"), @XmlEnumValue("RightButton")
	RIGHT_BUTTON("RightButton"), @XmlEnumValue("MiddleButton")
	MIDDLE_BUTTON("MiddleButton"), @XmlEnumValue("WheelUp")
	WHEEL_UP("WheelUp"), @XmlEnumValue("WheelDown")
	WHEEL_DOWN("WheelDown"), @XmlEnumValue("XButton1")
	X_BUTTON_1("XButton1"), @XmlEnumValue("XButton2")
	X_BUTTON_2("XButton2"), @XmlEnumValue("MouseStateMask")

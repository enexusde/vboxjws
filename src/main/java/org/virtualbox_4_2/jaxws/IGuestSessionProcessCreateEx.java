...
@XmlType(name = "", propOrder = { "_this", "command", "arguments", "environment", "flags", "timeoutMS", "priority",
		"affinity" })
...
public class IGuestSessionProcessCreateEx {
	 ...
	 * 
	 * @return possible object is {@link ProcessPriority }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link ProcessPriority }
	 * 
	 */

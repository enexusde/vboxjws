...
@XmlType(name = "", propOrder = { "_this", "templateName", "mode", "path", "secure" })
@XmlRootElement(name = "IGuestSession_directoryCreateTemp")
public class IGuestSessionDirectoryCreateTemp {

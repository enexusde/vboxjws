...
public enum DeviceType {
	...
	@XmlEnumValue("Null")
	NULL("Null"), @XmlEnumValue("Floppy")
	FLOPPY("Floppy"), DVD("DVD"), @XmlEnumValue("HardDisk")
	HARD_DISK("HardDisk"), @XmlEnumValue("Network")
	NETWORK("Network"), USB("USB"), @XmlEnumValue("SharedFolder")

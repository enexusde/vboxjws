...
/**
 * <p>
 * Java class for ProcessWaitResult.
 * 
 * <p>
 ...
 * 
 */
@XmlType(name = "ProcessWaitResult")
@XmlEnum
public enum ProcessWaitResult {
	...
	TERMINATE("Terminate"), @XmlEnumValue("Status")
	STATUS("Status"), @XmlEnumValue("Error")
	ERROR("Error"), @XmlEnumValue("Timeout")
	TIMEOUT("Timeout"), @XmlEnumValue("StdIn")
	STD_IN("StdIn"), @XmlEnumValue("StdOut")
	STD_OUT("StdOut"), @XmlEnumValue("StdErr")
	STD_ERR("StdErr"), @XmlEnumValue("WaitFlagNotSupported")

...
/**
 * <p>
 * Java class for IMediumAttachment complex type.
 * 
 * <p>
...
@XmlType(name = "IMediumAttachment", propOrder = { "medium", "controller", "port", "device", "type", "passthrough",
		"temporaryEject", "isEjected", "nonRotational", "discard", "bandwidthGroup" })

...
/**
 * <p>
 * Java class for HWVirtExPropertyType.
 * 
 * <p>
...
public enum HWVirtExPropertyType {
	...
	@XmlEnumValue("Null")
	NULL("Null"), @XmlEnumValue("Enabled")
	ENABLED("Enabled"), @XmlEnumValue("Exclusive")
	EXCLUSIVE("Exclusive"), VPID("VPID"), @XmlEnumValue("NestedPaging")
	NESTED_PAGING("NestedPaging"), @XmlEnumValue("LargePages")
	LARGE_PAGES("LargePages"), @XmlEnumValue("Force")
	FORCE("Force");

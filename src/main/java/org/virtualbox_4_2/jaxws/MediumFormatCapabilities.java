...
/**
 * <p>
 * Java class for MediumFormatCapabilities.
 * 
 * <p>
...
public enum MediumFormatCapabilities {
	...
	@XmlEnumValue("Uuid")
	UUID("Uuid"), @XmlEnumValue("CreateFixed")
	CREATE_FIXED("CreateFixed"), @XmlEnumValue("CreateDynamic")
	CREATE_DYNAMIC("CreateDynamic"), @XmlEnumValue("CreateSplit2G")
	CREATE_SPLIT_2_G("CreateSplit2G"), @XmlEnumValue("Differencing")
	DIFFERENCING("Differencing"), @XmlEnumValue("Asynchronous")
	ASYNCHRONOUS("Asynchronous"), @XmlEnumValue("File")
	FILE("File"), @XmlEnumValue("Properties")
	PROPERTIES("Properties"), @XmlEnumValue("TcpNetworking")
	TCP_NETWORKING("TcpNetworking"), VFS("VFS"), @XmlEnumValue("CapabilityMask")
